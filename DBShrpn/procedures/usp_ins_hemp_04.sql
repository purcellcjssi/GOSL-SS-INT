...
IF OBJECT_ID(N'dbo.usp_ins_hemp_04') IS NOT NULL
BEGIN
    DROP PROCEDURE dbo.usp_ins_hemp_04
    IF OBJECT_ID(N'dbo.usp_ins_hemp_04') IS NOT NULL
        PRINT N'<<< FAILED DROPPING PROCEDURE dbo.usp_ins_hemp_04 >>>'
    ELSE
        PRINT N'<<< DROPPED PROCEDURE dbo.usp_ins_hemp_04 >>>'
END
...
IF OBJECT_ID(N'dbo.usp_ins_hemp_04', N'P') IS NOT NULL
    PRINT N'<<< CREATED PROCEDURE dbo.usp_ins_hemp_04 >>>'
ELSE
    PRINT N'<<< FAILED CREATING PROCEDURE dbo.usp_ins_hemp_04 >>>'
GO