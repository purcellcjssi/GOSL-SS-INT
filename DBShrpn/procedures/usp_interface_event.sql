USE [DBShrpn]
GO
/****** Object:  StoredProcedure [dbo].[usp_interface_event]    Script Date: 4/1/2025 4:33:00 PM ******/
SET ANSI_NULLS OFF
GO
...
CREATE procedure [dbo].[usp_interface_event]
As
BEGIN  
--
--  EXEC [dbo].[usp_interface_event]
--
INSERT INTO DBShrpn.dbo.ghr_events 
SELECT CAST('INTERFACE' AS char(255))   As [desc], 'I' As status_flag;
...
SELECT	@w_psc_userid            =	'JGROSS', 
		@w_psc_batchname         =	'GHR', 
		@w_psc_qualifier         =	'INTERFACES', 
		@w_psc_batchtype         =	'I', 
		@w_psc_description       =	'Interfaces from the cloud HR system', 
	...
	SELECT	@w_psc_nxt_run_date			=	'',			
	 ...
	 WHERE [psc_userid] = 'JGROSS' AND	[psc_batchname]	=	'GHR'  AND [psc_qualifier] = 'INTERFACES'		
...
GO
ALTER AUTHORIZATION ON [dbo].[usp_interface_event] TO  SCHEMA OWNER 
GO
